describe('Testing api', () => {
    it('create user', () => {
        ...
        cy.wait(1000);
        cy.get('main > div > form > fieldset.form-group.form > input').type('juust@mail.com');
        cy.wait(1000);
        cy.get('main > div > form > fieldset:nth-child(2) > input').type('juust');
        cy.wait(1000);
    ...
    it('Edit user', () => {
        ...
        cy.wait(1000);
        cy.get('form:nth-child(1) > .form-group:nth-child(1) > .form-control').type('maaja@mail.ee');
        cy.wait(1000);
        ...
        cy.wait(1000);
        cy.get('div.modal > div > div > form > fieldset:nth-child(2) > input').type('maaja');
